...
for jj = 2:4
    ...
    trainParam.lagFrames = round(3/dsRate(jj)):round(9/dsRate(jj));%0:6;%3:6;%0:9 %frame delays to train a neuron
    ...
    tic;
    trained = trainAneuron(ds, S_fin, roiIdx, trainIdx,  ...
        trainParam.ridgeParam, trainParam.KFolds, [trainParam.lagFrames(1) trainParam.lagFrames(end)], ...
